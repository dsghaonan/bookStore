...
<style type="text/css">
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/bookstore/WebRoot/adminjsps/admin/category/add.jsp">
    <h1 data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/bookstore/WebRoot/adminjsps/admin/category/add.jsp">添加分类</h1>
