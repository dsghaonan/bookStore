...
<style type="text/css">
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-7" data-genuitec-path="/bookstore/WebRoot/adminjsps/admin/category/mod.jsp">
    <h1 data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-7" data-genuitec-path="/bookstore/WebRoot/adminjsps/admin/category/mod.jsp">修改分类</h1>
